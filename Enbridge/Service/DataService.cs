...
namespace Enbridge.Service
{
    public class DataService
    {
        public List<Data> ShortColumn(string columnName)
        {
        ...
        private bool SelectColumnIsNotValid(string columnName)
        {
        ...
        private List<Data> InitilizeData()
        {
